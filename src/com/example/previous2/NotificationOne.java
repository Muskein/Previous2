...
import com.example.previous2.NotificationOne.ImageAdapter;
...
*/
		        ...
		        {
		        	//Toast.makeText(getApplicationContext(), "First " + imagepath[0] + " Second " + imagepath[1], Toast.LENGTH_SHORT).show();
