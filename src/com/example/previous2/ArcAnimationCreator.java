...
public class ArcAnimationCreator 
{
    ...
    {        
        ...
        rotate.setInterpolator(context, R.anim.arc_item_in_rotate_interpolator);
        ...
        translate.setInterpolator(context, R.anim.arc_item_anticipate_interpolator);
